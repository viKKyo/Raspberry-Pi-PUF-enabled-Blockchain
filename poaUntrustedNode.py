...
class Blockchain:
    ...
    def new_block(self, previous_hash):
        ...
        sig = elGamal.sign(str(block))
        if previous_hash == '1':
            self.chain.append(block)
                  
        else:
            self.measure()
            with CodeTimer('Proof of authentication'):
                res = requests.post(f'http://192.168.100.101:5000/get/sig', json=sig)
    ...
    def measure(self):
        fileLoc = "/home/pi/results/resultsPoA.txt"
